    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Actions</th> <!-- Set class for Actions column -->
            </tr>
        </thead>
        <tbody>
            <%
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <a href="editVenue.jsp?id=<%= venueId %>" class="action-btn edit-btn"><i class="fas fa-edit"></i>Edit</a>

                    <!-- Delete Button with Confirmation -->
<a href="deleteVenue.jsp?id=<%= venueId %>" class="action-btn delete-btn" 
