    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <!-- Edit Button -->
                    <a href="editSlot.jsp?id=<%= slotId %>" class="action-btn edit-btn"><i class="fas fa-edit"></i>Edit</a>

                    <!-- Delete Button with Confirmation -->
                    <a href="deleteSlot.jsp?id=<%= slotId %>" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this slot?');"><i class="fas fa-trash-alt"></i>Delete</a>
                </td>
            </tr>
            <%
                    }
